...
function preload() {
  bgm = loadSound('COMM2754-2025-S3-A2W08-PredictedWound-underwaterambience-sound.wav');
  whaleAmb = loadSound('COMM2754-2025-S3-A2W08-PredictedWound-whale-sound.wav');
  beepAmb = loadSound('COMM2754-2025-S3-A2W08-PredictedWound-beep-sound.wav');
  clickSnd = loadSound('COMM2754-2025-S3-A2W08-PredictedWound-littering-sound.wav');
  bubbleAmb = loadSound('COMM2754-2025-S3-A2w08-PredictedWound-bubble-sound.wav');
  constructionAmb = loadSound('COMM2754-2025-S3-A2w08-PredictedWound-construction.wav');
  waveAmb = loadSound('COMM2754-2025-S3-A2w08-PredictedWound-wave.wav');
  electromagneticAmb = loadSound('COMM2754-2025-S3-A2w08-PredictedWound-electromagnetic-sound.wav');
  explosionSnd = loadSound('COMM2754-2025-S3-A2w08-PredictedWound-explosion-sound.wav');
